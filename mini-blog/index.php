    ...
    <div class="container">
        ...
        <div class="grid grid-2" style="margin-top:16px">
            ...
            <section class="card">
                ...
                <p class="muted" style="margin-top:8px">Mẹo: nhấn <span class="kbd">/</span> để focus nhanh ô tìm kiếm.
                </p>
            </section>
        </div>
        ...
        <footer>
            Made with 💜 for K9Tin • An toàn: PDO + Prepared • CSRF token • XSS escape
        </footer>
    </div>

    <script>
    // Mẹo UX: nhấn "/" để focus ô tìm kiếm
